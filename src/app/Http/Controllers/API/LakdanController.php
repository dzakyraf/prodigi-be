...
class LakdanController extends AppBaseController
{
    ...
    public function saveDraft(SaveDraftRendanAPIRequest $request): JsonResponse
    {
        ...
        $file_ms  = $this->proposalModel->getDocuments(3, $procurement_id);
        ...
        foreach ($file_ms as $doc) {
            ...
            if ($value != null) {
                $form  = ProcurementDocsData::from([
                    'procurement_process_id' => ProcurementProcess::DOKUMEN_LAKDAN->value,
    ...
    public function submit(SaveDraftRendanAPIRequest $request): JsonResponse
    {
        ...
        DB::table('prod_procurement')
            ...
            ->update(['last_status' => ApprovalStatus::OnDraft->value, 'last_process_id' => ProcurementProcess::DOKUMEN_PENYELESAIAN->value,]);
